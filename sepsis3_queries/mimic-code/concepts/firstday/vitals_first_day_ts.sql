...
DROP TABLE IF EXISTS vitals_first_day_ts; CREATE TABLE vitals_first_day_ts AS 
...
FROM  (
  ...
  -- Original line: ce.charttime between ie.intime and DATETIME_ADD(ie.intime, INTERVAL '1' DAY)
  and ce.charttime between ie.intime and (ie.intime + INTERVAL '1' DAY)

  -- Original line: DATETIME_DIFF(ce.charttime, ie.intime, 'SECOND') > 0
  and (ce.charttime - ie.intime) > INTERVAL '0' SECOND

  -- Original line: DATETIME_DIFF(ce.charttime, ie.intime, 'HOUR') <= 24
